...
- [ ] **Linha de visão automática** — ainda não implementado. Ideia: ao mover um token num mapa de tiles, revelar automaticamente as células de névoa num raio da posição dele, em vez do Mestre precisar pintar a névoa manualmente célula por célula.
